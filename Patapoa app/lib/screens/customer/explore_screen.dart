              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Text('TOP CATEGORY', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                  ),
                  const SizedBox(height: 4),
                  Text(hero.name, style: textTheme.headlineSmall?.copyWith(color: Colors.white, fontWeight: FontWeight.bold)),
                  if (hero.description != null)
                    Text(hero.description!, style: const TextStyle(color: Colors.white70, fontSize: 12)),
                ],
              ),
            ),
          ],
    ...
    return LiquidGlassContainer(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search for sugar, milk, flour...',
      ...
      child: InkWell(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(product.fullDisplayName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            Text(
            ...
            Row(
              children: [
                Text('TZS ${product.price.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                const Spacer(),
