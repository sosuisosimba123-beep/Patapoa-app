...
class ApiConfig {
  ...
  static String userUpdateLocation(String id) => '/users/$id/location';
  static String userUpdateFcmToken(String id) => '/users/$id/fcm-token';
  ...
  static String paymentsStatus(String orderId) => '/payments/$orderId/status';
  ...
  static String merchantProduct(String id) => '/merchant/products/$id';
  static String merchantUpdateOrderStatus(String id) =>
  ...
  static String riderAcceptOrder(String id) => '/delivery-partner/orders/$id/accept';
  static String riderUpdateOrderStatus(String id) => '/delivery-partner/orders/$id/status';
